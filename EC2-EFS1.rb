...
puts 'CloudwatchPutMetricsRole resource done...'
...
puts 'CloudWatchPutMetricsRolePolicy resource done...'
  resource 'CloudWatchPutMetricsInstanceProfile', :Type => 'AWS::IAM::InstanceProfile', :Properties => {
      :Path => '/',
      :Roles => [ ref('CloudWatchPutMetricsRole') ],
  }
  puts 'CloudWatchPutMetricsInstanceProfile resource done...'
  ...
  puts 'LaunchConfiguration resource done...'
  ...
  puts 'AutoScalingGroup resource done...'
